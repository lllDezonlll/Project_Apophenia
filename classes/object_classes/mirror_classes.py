import pygame
from Constant_files.SPRITE_GROUPS import game_sprite_group, object_sprite_group, mirror_sprite_group, texture_mirror_sprite_group, texture_health_group
...
class Mirror(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, orientation, board, health=99, state='normal', unique_abilities=None, is_place_action=False):
